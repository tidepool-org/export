...
import { config, log, buildHeaders, createCounter } from './app';
...
export function userDataExportHandler() {
      ...
      try {
        await new Promise((resolve, reject) => {
          ...
          res.on('timeout', async () => {
            dataStatusCount.inc({ status_code: 408, export_format: exportFormat });
            reject(
              new Error(
