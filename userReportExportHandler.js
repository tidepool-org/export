import { config, createCounter } from './app';

import { DataUtil } from '@tidepool/viz/dist/data';
import { validateQueryParams } from './report_queries/query';
...
export function userReportExportHandler() {
  return async (req, res) => {
    ...
    var missing = validateQueryParams(req.body);
